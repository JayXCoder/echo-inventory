		...
		<div class="right"><br>
			...
			<center>
				...
				while ($row = mysqli_fetch_array($query)) 
				{
					...
					<input type="text" name="cemail" class="form" value="<?php echo $row['cemail']; ?>" required="required"><br><br>
					<input type="text" name="empnom" class="form" value="<?php echo $row['empnom']; ?>" required="required"><br><br>
					<?php
				}
				 ?>
