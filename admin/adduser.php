	 ...
	 ?>
		<div class="right"><br>
			...
			<center>
				...
				<input type="text" name="cemail" class="form" placeholder="Enter Staff Email" required="required"><br><br>
				<input type="text" name="empnom" class="form" placeholder="Enter Employer Number" required="required"><br><br>
